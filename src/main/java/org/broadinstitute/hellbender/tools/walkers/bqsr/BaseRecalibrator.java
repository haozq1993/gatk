...
public final class BaseRecalibrator extends ReadWalker {
    ...
    public List<ReadFilter> getDefaultReadFilters() {
        return getFullBQSRReadFilterList();
    }
     ...
     */
    public static List<ReadFilter> getFullBQSRReadFilterList() {
        final List<ReadFilter> bqsrFilters = getBasicBQSRReadFilterList();
     ...
     */
    public static List<ReadFilter> getBasicBQSRReadFilterList() {
