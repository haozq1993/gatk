...
public final class UpdateVCFSequenceDictionary extends VariantWalker {
    ...
    public final static String dictionaryArgumentName = "sourceDictionary";
    @Argument(fullName=dictionaryArgumentName,
            shortName=dictionaryArgumentName,
    ...
    public final static String replaceArgumentName = "replace";
    @Argument(fullName=replaceArgumentName,
            shortName=replaceArgumentName,
        ...
        if (source == null) {
            if (hasReference()) {
                ...
                throw new UserException.MissingArgument(
                        dictionaryArgumentName, "A dictionary source file or reference file must be provided");
            }
